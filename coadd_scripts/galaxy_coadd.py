...
def main(dr_name,galaxy_type):
    ...
    # calculate SNR
    snr_narrow, snr_broad, noise, noise_broad = compute_SNR(wave, smoothed_narrow, smoothed_broad, valid_bins)
    ...
    save_results(wave, flux, error, residual, snr_narrow, snr_broad, valid_bins, 
                n_spectra, continuum, noise,noise_broad, base_output_dir, galaxy_type,dr_name,processed_galaxies)
    ...
    plot(wave,flux,continuum,residual,smoothed_narrow, smoothed_broad,noise, noise_broad,snr_narrow,snr_broad,valid_bins,all_galaxy_mask,plot_dir)
